...
def fun(dane_wejsciowe):
	...
	wsad = "{'Depresja (DSM-5)': 66, 'Paranoidalne zaburzenie osobowosci (DSM-IV)': True, 'Anankastyczne zaburzenie osobowosci (DSM-IV)': True, 'Paranoidalne zaburzenie osobowosci (ICD-10)': True, 'Histrioniczne zaburzenie osobowosci (DSM-IV)': True, 'Unikowe zaburzenie osobowosci (ICD-10)': True, 'Unikowe zaburzenie osobowosci (DSM-IV)': True, 'Zespol leku uogolnionego (ICD-10)': True, 'Zespol leku uogolnionego (DSM-5)': False, 'Histrioniczne zaburzenie osobowosci (ICD-10)': True, 'Anankastyczne zaburzenie osobowosci (ICD-10)': True, 'Depresja (ICD-10)': True, 'Zaburzenie obsesyjno-kompulsyjne (ICD-10)': True}"
	wsad = str(wypis_datalog_dla_quizu)
	cmd = 'echo '
	cmd = cmd + wsad
	cmd = cmd + ' > '
	cmd = cmd + "/home/wbubicz/arche/backend/output.txt"
	#cmd = cmd + '"D:\\prog\\mgr\\psycho\\arche\\backend\\output.txt"'
	os.system(cmd)
